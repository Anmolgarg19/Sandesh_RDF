...
def getdataa():
	...
	for result in results["results"]["bindings"]:
		...
		header_property_map[result["AncColInd"]["value"]] = result["AncColType"]["value"]+"|"+result["AncColType"]["value"]
		header_property_map[result["ColIndex"]["value"]] = result["ConnectedColType"]["value"]+"|"+result["Prop"]["value"]
